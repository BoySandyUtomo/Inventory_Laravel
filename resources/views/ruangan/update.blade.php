    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        @if(count($errors) > 0)
          ...
          <form method="post" action="{{ url('/updateRua/' . $ruangan->id_ru) }}" autocomplete="off" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                    ...
                    <select class="form-control" id="id_jur" name="id_jur">
                        ...
                        @foreach($jurusan as $jur)
                            <option value="{{ $jur->id_jur }}" {{ ($ruangan->id_jur == $jur->id_jur) ? 'selected' : ''}} >{{ $jur->nama_jur }}</option>
                        @endforeach
                    </select>
                </div>

            <div class="form-group">
                  <label for="nama_ru">Ruangan</label>
                  <input type="text" class="form-control" id="nama_ru" name="nama_ru" value="{{ $ruangan->nama_ru }}">
             </div>
